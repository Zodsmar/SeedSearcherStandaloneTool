...
public class Feature_Registry {
    ...
    //Custom Structures
    public static final String ZOMBIEVILLAGE = register("ZombieVillage", Village::new);
    public static final String IGLOOBASEMENT = register("IglooBasement", Igloo::new);
    ...
    //Decorators
    public static final String DESERTWELL = register(DesertWell.class.getSimpleName(), DesertWell::new);
