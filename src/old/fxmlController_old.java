...
public class fxmlController_old implements Initializable {
    ...
    Util util;
    sassa.gui.guiCollector guiCollector;
...
//                Main.DEV_MODE = !Main.DEV_MODE;
    ...
    Searcher_old createNewThread() throws IOException, FormatException, MinecraftInterfaceCreationException {
        r = new Searcher_old(
                minecraftVersion,
